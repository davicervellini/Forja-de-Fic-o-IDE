...
class PipelineOrchestrator:
    ...
    def _run_summarizing(
        ...
        from pipeline.prompts import build_summarizing_prompt, SYSTEM_SUMMARIZING
    ...
    def _run_updating(
        ...
        from pipeline.prompts import build_updating_prompt, SYSTEM_UPDATING
    ...
    def _run_merging(
        ...
        from pipeline.prompts import build_merging_prompt, SYSTEM_MERGING
    ...
    def run_single(
        ...
        # Salva a premissa no disco imediatamente (antes era perdido)
        chapter_dir = self.project.chapter_dir(chapter_num)
        ...
        try:
            ...
            self.project.last_chapter_num = chapter_num
