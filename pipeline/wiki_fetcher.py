...
para converter em uma "short sheet" compatível com a Bíblia do Mundo,
...
def search_fandom_wiki(character_name: str, franchise: str) -> str | None:
    ...
    try:
        r_search = requests.get(url, params=search_params, timeout=10)
        ...
        r_content = requests.get(url, params=content_params, timeout=10)
